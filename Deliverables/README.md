...
Este directorio agrupa los entregables del proyecto, organizados según el tipo de producto desarrollado:

- `API/` - Documentación, código fuente y distribución de la API REST.
- `WearableApp/` - Documentación, código fuente y distribución de la aplicación wearable.
