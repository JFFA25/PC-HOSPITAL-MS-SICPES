...
```
3. Importar el respaldo de la base de datos que se encuentra en la siguiente ruta:

```text
database/SQL/Backups/backup_estructural.sql
```
> Cualquier duda con la importacion de la base de datos , acceder al archivo  [Backup.md](/Databases/SQL/Backups/Backup.md) de la carpeta Backup de la carpeta de SQL.
